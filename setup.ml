...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3ee3e4268e743c6f5c18a039bb0ae333) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the Cohttp library";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the OCurl library";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the Ocamlnet library";
                      flag_default = [(OASISExpr.EBool true, false)];
                      });
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "oauth";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "oauth_cohttp";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      lib_modules =
                        ["Oauth_cohttp_http"; "Oauth_cohttp_http_client"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "oauth";
                      lib_findlib_name = Some "cohttp";
                      lib_findlib_containers = [];
                      });
               Executable
                 ({
                     cs_name = "client_termie";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      bs_path = "examples/term.ie";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "oauth_cohttp"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "client.ml"; });
               Executable
                 ({
                     cs_name = "client_localhost";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "server_cohttp.ml"; })
            ];
          plugins =
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\210n\198\137 \016\232\021\028-%;.\193\199\230";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
